            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6" data-aos="fade-up">
                ...
                <p className="text-muted mb-4">
                  Justifi was founded with the mission to bridge the gap between
                  those seeking legal advice and the expert advocates who can
                  provide it. We believe in leveraging technology to make legal
                  services more accessible, transparent, and efficient for
                  everyone.
                </p>
                <p className="text-muted mb-4">
                  After seeing one too many people forgo their legal rights due
                  to cost, complexity, or lack of access to quality counsel, Raj
                ...
                <div className="card h-100 border-0 shadow-lg">
                  <div className="card-body p-4 p-lg-5">
                    ...
                    <p className="card-text text-muted">
                      To democratize access to justice by providing a seamless,
                      secure, and reliable platform where users can connect with
                      qualified legal professionals for timely and affordable
                      advice.
                    </p>
                  </div>
                </div>
                ...
                <div className="card h-100 border-0 shadow-lg">
                  <div className="card-body p-4 p-lg-5">
                    ...
                    <p className="card-text text-muted">
                      ...
                      professional ethics, data security, and regulatory
                      compliance, ensuring a trustworthy environment for both
                      our users and advocates.
                    </p>
                  </div>
                </div>
              </div>
