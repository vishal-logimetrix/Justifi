...
const HighCourt = () => {
  ...
  // States and their respective bench IDs
  const statesAndBenches = {
    ...
    Telangana: ["Hyderabad"],
    Tripura: ["Agartala"],
    "Uttar Pradesh": ["PrayagRaj", "Lucknow"],
    Uttarakhand: ["Nainital"],
    "West Bengal": ["Calcutta", "Jalpaiguri"],
  };
  ...
  const validateStep1 = () => {
    ...
    if (formData.bench_ids.length === 0)
      newErrors.bench_ids = "Please select at least one bench";
  ...
  const handleStateChange = (e) => {
    ...
    setFormData((prev) => ({
      ...prev,
      state: selectedState,
      bench_ids: [], // Reset bench selection when state changes
    }));
    setErrors((prev) => ({ ...prev, state: "", bench_ids: "" }));
  };
  ...
  const handleBenchChange = (e) => {
    ...
    setFormData((prev) => ({
      ...prev,
      bench_ids: checked
        ? [...prev.bench_ids, value]
        : prev.bench_ids.filter((id) => id !== value),
    }));
    setErrors((prev) => ({ ...prev, bench_ids: "" }));
  };
  ...
  const handlePayment = async () => {
    ...
    try {
      const options = {
        ...
        description: "High Court Lawyer Registration Fee",
        modal: {
                ...
                <div className="card-header bg-white py-4">
                  ...
                  <div className="text-center">
                    <h1 className="h3 fw-bold text-primary">
                      High Court Lawyer Registration
                    </h1>
                    <p className="text-muted mb-0">
                      Register to access exclusive High Court resources
                    </p>
                  </div>
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="input-group mb-1">
                            ...
                            >
                              ...
                              {Object.keys(statesAndBenches).map((state) => (
                        ...
                        {formData.state && (
                          <div className="col-6">
                            ...
                            <Select
                              isMulti
                              name="bench_ids"
                              options={statesAndBenches[formData.state].map(
                                (bench) => ({
                                  value: bench,
                                  label: bench,
                                })
                              )}
                              value={formData.bench_ids.map((bench) => ({
                                value: bench,
                                label: bench,
                              }))}
                    ...
                    <div>
                      ...
                      <div className="card border-success mb-4">
                        <div className="card-body text-center py-5">
                          ...
                          <p className="lead">
                            Thank you for registering as a High Court Lawyer.
