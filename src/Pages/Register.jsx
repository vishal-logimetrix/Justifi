        ...
        <div className="row g-0 h-100">
          ...
          >
            ...
            <div
              ...
              style={{ width: "400px", height: "400px", transform: "translate(-200px, 200px)" }}
            ></div>
            <div
              className="position-absolute top-50 start-0 bg-info opacity-10"
              style={{ width: "150px", height: "150px", transform: "translate(-50%, -50%) rotate(45deg)" }}
            ></div>
          ...
          <div className="col-lg-5 d-flex align-items-center justify-content-center p-4 p-md-3 bg-light" style={{overflowX: 'scroll'}} >
            <div className="w-100" style={{ height: "90vh"}}>
              <div className="text-center mt-5">
                ...
                <p className="text-muted">Join our network of legal professionals</p>
              </div>

              <div className="d-flex justify-content-center mb-3">
                <button
                  className={`btn me-2 ${activeTab === "lawyer" ? "btn-primary" : "btn-outline-primary"}`}
